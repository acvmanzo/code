...
#Runs edgeR analysis on the indicated groups.
    batch_pairwise_DE(MALES, MALES_CTRL, gene_subset, RNASEQDICT, tool)
    batch_pairwise_DE(FEMALES, FEMALES_CTRL, gene_subset, RNASEQDICT, tool)
    run2groups_DE(AGG_DICT_ALL, gene_subset, RNASEQDICT, tool)
    run2groups_DE(AGG_DICT_CS, gene_subset, RNASEQDICT, tool)
    run2groups_DE(MUT_DICT_MALES, gene_subset, RNASEQDICT, tool)
    run2groups_DE(MUT_DICT_FEMALES, gene_subset, RNASEQDICT, tool)

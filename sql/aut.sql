...
-- UPDATE autin SET indexnum = 28 WHERE samplenum = 1053 AND genotype = 'pten' AND cdnad = '2014-05-06';
-- UPDATE autin SET indexnum = 48 WHERE samplenum = 1054 AND genotype = 'NrxIV' AND cdnad = '2014-05-06';
-- UPDATE autin SET indexnum = 32 WHERE samplenum = 1055 AND genotype = 'Nhe3' AND cdnad = '2014-05-06';
-- select samplenum, genotype, sex, indexnum, mrnad, cdnad from autin where mrnad = '2014-04-23';
...
-- UPDATE autin SET sample = 'Betaintnu_FC' where samplenum = 1046 and genotype = 'Betaintnu' and cdnad = '2014-04-24';
-- UPDATE autin SET sample = 'NrxI_FC' where samplenum = 1047 and genotype = 'NrxI' and cdnad = '2014-04-24';
-- UPDATE autin SET sample = 'pten_FC' where samplenum = 1048 and genotype = 'pten' and cdnad = '2014-04-24';
-- UPDATE autin SET sample = 'en_FC' where samplenum = 1051 and genotype = 'en' and cdnad = '2014-04-24';
-- UPDATE autin SET sample = 'pten_MD' where samplenum = 1053 and genotype = 'pten' and cdnad = '2014-05-06';
-- UPDATE autin SET sample = 'NrxIV_FC' where samplenum = 1054 and genotype = 'NrxIV' and cdnad = '2014-05-06';
-- UPDATE autin SET sample = 'Nhe3_FC' where samplenum = 1055 and genotype = 'Nhe3' and cdnad = '2014-05-06';



-- TO COPY SAMPLE AND INDEX INTO A FILE FOR SENDING TO BERKELEY:
-- \copy (select sample, indexnum, indexseq from berkeley_order where cdnad > '2014-04-23' order by indexnum) TO '/home/andrea/Documents/lab/RNAseq/berkeley_samples_sent/2014-0507/2014-05-07_samples_to_send_info_noberkid.csv' header csv;
